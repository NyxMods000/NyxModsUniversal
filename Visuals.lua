...
local function UpdatePlayerEsp(Player)
  ...
  if Config.Esp.Objects[Player] then
    ...
    if not Esp.Line and not Esp.Box and not Esp.Name and not Esp.DisplayName and not Esp.Health and not Esp.Distance and not Esp.Skeleton then
...
if Config.Esp.Name or Config.Esp.DisplayName or Config.Esp.Health or Config.Esp.Distance then
